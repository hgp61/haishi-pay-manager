...
<body>
  <div class="card">
    ...
    <div class="jump-view" id="jumpView">
      <div class="logo">海狮PAY</div>
      <div class="brand">HAISHI PAY</div>
...
Promise.all([loadOrders(), loadSecurity(), loadLimits()]).then(() => {
  app.listen(PORT, () => {
    console.log('');
    console.log('========================================');
    console.log('  海狮PAY 收银台 · UID 版 已启动');
